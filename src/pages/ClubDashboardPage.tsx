        ...
        <div className="min-h-screen bg-gray-50 p-6">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900">Dashboard Club</h1>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                                    ...
                                    <tr key={team.id} className="hover:bg-gray-50 transition-colors">
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-xs text-gray-500">{team.category_stage}</span>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-6 py-4">
                                            {latestEvaluation?.dominant_weakness ? (
                                                ...
                                                <span className="text-sm text-gray-400 italic">Sin evaluar</span>
                                            )}
                                        </td>
                                        <td className="px-4 py-4 text-center">
                ...
                {teamsData.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-500 mt-1">Crea equipos para ver el dashboard del club.</p>
                    </div>
                )}
            </div>
            ...
            <div className="mt-6 bg-white rounded-lg border border-gray-200 p-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-700">Cumplido</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <AlertCircle className="w-5 h-5 text-yellow-600" />
                        <span className="text-gray-700">Parcial</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <XCircle className="w-5 h-5 text-red-600" />
                        <span className="text-gray-700">No Cumplido</span>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm mt-3 pt-3 border-t border-gray-200">
                    <div className="flex items-center gap-2">
                        <TrendingUp className="w-5 h-5 text-green-600" />
                        <span className="text-gray-700">Mejorando ↑</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <Minus className="w-5 h-5 text-gray-600" />
                        <span className="text-gray-700">Estable —</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <TrendingDown className="w-5 h-5 text-red-600" />
                        <span className="text-gray-700">Empeorando ↓</span>
                    </div>
                </div>
            </div>
        </div>
